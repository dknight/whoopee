...
> If you plan to use tables or function as set indexes (which is probably not
...
> Another notice. Set use `table` as data stroge. If you are going to iterate
  ...
  Check Lua maual or [`pairs()` iterator](https://www.lua.org/manual/5.4/manual.html#pdf-pairs).
